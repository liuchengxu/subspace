//! This module defines a trait for building the domain extrinsics from a primary block and
//! provides the implementation for both system domain and core domain.
